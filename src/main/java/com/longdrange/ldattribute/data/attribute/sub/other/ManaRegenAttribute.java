...
public class ManaRegenAttribute extends LDSubAttribute {
    public ManaRegenAttribute() {
        super("法力恢复", 1, LDAttributeType.UPDATE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("法力恢复"); }
}