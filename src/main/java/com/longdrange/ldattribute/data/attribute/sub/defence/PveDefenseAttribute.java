...
public class PveDefenseAttribute extends LDSubAttribute {
    public PveDefenseAttribute() {
        super("PVE防御", 1, LDAttributeType.DEFENSE);
    }
    ...
    public void eventMethod(LDEventData data) {
        ...
        if (dd.getAttacker() instanceof Player) return;
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("PVE防御"); }
}