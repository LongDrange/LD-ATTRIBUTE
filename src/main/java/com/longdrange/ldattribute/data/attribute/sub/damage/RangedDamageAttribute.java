...
public class RangedDamageAttribute extends LDSubAttribute {
    public RangedDamageAttribute() {
        super("远程伤害", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("远程伤害"); }
}