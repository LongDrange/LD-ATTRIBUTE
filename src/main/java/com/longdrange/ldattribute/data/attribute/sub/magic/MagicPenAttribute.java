...
public class MagicPenAttribute extends LDSubAttribute {
    public MagicPenAttribute() {
        super("法术穿透", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("法术穿透"); }
}