...
public class ManaMaxAttribute extends LDSubAttribute {
    public ManaMaxAttribute() {
        super("法力上限", 1, LDAttributeType.UPDATE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("法力上限"); }
}