...
public class DamageAmplifyAttribute extends LDSubAttribute {
    public DamageAmplifyAttribute() {
        super("伤害加成", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("伤害加成"); }
}