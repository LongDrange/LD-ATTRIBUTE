...
public class LifeStealRatioAttribute extends LDSubAttribute {
    public LifeStealRatioAttribute() {
        super("吸血倍率", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("吸血倍率"); }
}