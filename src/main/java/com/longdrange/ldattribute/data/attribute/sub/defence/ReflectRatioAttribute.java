...
public class ReflectRatioAttribute extends LDSubAttribute {
    public ReflectRatioAttribute() {
        super("反伤倍率", 1, LDAttributeType.DEFENSE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("反伤倍率"); }
}