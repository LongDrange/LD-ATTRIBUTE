...
public class ExtraDamageAttribute extends LDSubAttribute {
    public ExtraDamageAttribute() {
        super("附加伤害", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("附加伤害"); }
}