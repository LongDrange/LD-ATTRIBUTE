...
public class ReflectResistAttribute extends LDSubAttribute {
    public ReflectResistAttribute() {
        super("反伤抵抗", 1, LDAttributeType.DEFENSE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("反伤抵抗"); }
}