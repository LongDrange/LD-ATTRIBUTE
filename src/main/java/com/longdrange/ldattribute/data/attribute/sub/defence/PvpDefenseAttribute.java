...
public class PvpDefenseAttribute extends LDSubAttribute {
    public PvpDefenseAttribute() {
        super("PVP防御", 1, LDAttributeType.DEFENSE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("PVP防御"); }
}