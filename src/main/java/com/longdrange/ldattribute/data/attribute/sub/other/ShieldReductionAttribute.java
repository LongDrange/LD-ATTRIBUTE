...
public class ShieldReductionAttribute extends LDSubAttribute {
    public ShieldReductionAttribute() {
        super("盾牌减伤", 1, LDAttributeType.DEFENSE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("盾牌减伤"); }
}