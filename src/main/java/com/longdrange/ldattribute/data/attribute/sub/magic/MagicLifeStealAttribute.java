...
public class MagicLifeStealAttribute extends LDSubAttribute {
    public MagicLifeStealAttribute() {
        super("法术吸血", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("法术吸血"); }
}