...
public class BurnDamageAttribute extends LDSubAttribute {
    public BurnDamageAttribute() {
        super("燃烧伤害", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("燃烧伤害"); }
}