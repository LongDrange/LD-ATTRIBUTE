...
public class ArrowAccuracyAttribute extends LDSubAttribute {
    public ArrowAccuracyAttribute() {
        super("箭矢精准", 1, LDAttributeType.OTHER);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("箭矢精准"); }
}