...
public class MagicCritChanceAttribute extends LDSubAttribute {
    public MagicCritChanceAttribute() {
        super("法术暴击几率", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("法术暴击几率"); }
}