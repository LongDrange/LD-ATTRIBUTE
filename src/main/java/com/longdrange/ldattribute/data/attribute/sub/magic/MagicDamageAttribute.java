...
public class MagicDamageAttribute extends LDSubAttribute {
    public MagicDamageAttribute() {
        super("法术伤害", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("法术伤害"); }
}