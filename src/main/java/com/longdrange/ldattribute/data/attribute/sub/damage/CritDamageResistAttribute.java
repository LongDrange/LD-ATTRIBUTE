...
public class CritDamageResistAttribute extends LDSubAttribute {
    public CritDamageResistAttribute() {
        super("暴伤抵抗", 1, LDAttributeType.DEFENSE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("暴伤抵抗"); }
}