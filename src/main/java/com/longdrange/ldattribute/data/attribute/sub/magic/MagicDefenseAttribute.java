...
public class MagicDefenseAttribute extends LDSubAttribute {
    public MagicDefenseAttribute() {
        super("法术防御", 1, LDAttributeType.DEFENSE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("法术防御"); }
}