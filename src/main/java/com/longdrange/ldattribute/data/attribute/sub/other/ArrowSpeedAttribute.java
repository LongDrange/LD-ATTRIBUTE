...
public class ArrowSpeedAttribute extends LDSubAttribute {
    public ArrowSpeedAttribute() {
        super("箭矢速度", 1, LDAttributeType.OTHER);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("箭矢速度"); }
}