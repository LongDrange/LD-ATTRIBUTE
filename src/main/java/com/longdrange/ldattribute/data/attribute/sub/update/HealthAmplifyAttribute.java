...
public class HealthAmplifyAttribute extends LDSubAttribute {
    public HealthAmplifyAttribute() {
        super("生命加成", 1, LDAttributeType.UPDATE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("生命加成"); }
}