...
public class CooldownReductionAttribute extends LDSubAttribute {
    public CooldownReductionAttribute() {
        super("技能极速", 1, LDAttributeType.OTHER);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("技能极速"); }
}