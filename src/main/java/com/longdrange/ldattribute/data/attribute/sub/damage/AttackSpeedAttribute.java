...
public class AttackSpeedAttribute extends LDSubAttribute {
    public AttackSpeedAttribute() {
        super("攻击速度", 1, LDAttributeType.UPDATE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("攻击速度"); }
}