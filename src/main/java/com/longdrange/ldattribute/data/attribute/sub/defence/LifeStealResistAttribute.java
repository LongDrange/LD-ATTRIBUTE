...
public class LifeStealResistAttribute extends LDSubAttribute {
    public LifeStealResistAttribute() {
        super("吸血抵抗", 1, LDAttributeType.DEFENSE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("吸血抵抗"); }
}