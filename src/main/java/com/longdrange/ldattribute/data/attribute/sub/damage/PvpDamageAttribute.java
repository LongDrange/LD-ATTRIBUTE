...
public class PvpDamageAttribute extends LDSubAttribute {
    public PvpDamageAttribute() {
        super("PVP攻击力", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("PVP攻击力"); }
}