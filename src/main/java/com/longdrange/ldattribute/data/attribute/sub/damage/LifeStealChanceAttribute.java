...
public class LifeStealChanceAttribute extends LDSubAttribute {
    public LifeStealChanceAttribute() {
        super("吸血几率", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("吸血几率"); }
}