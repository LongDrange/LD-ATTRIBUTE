...
public class BurnChanceAttribute extends LDSubAttribute {
    public BurnChanceAttribute() {
        super("燃烧几率", 1, LDAttributeType.ATTACK);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("燃烧几率"); }
}