...
public class HealthRegenAttribute extends LDSubAttribute {
    public HealthRegenAttribute() {
        super("生命恢复", 1, LDAttributeType.UPDATE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("生命恢复"); }
}