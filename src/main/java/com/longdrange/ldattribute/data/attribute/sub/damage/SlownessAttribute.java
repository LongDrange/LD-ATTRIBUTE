 ...
 * Lore 格式：緩速: 5/1
 */
public class SlownessAttribute extends LDSubAttribute {

    public SlownessAttribute() {
        super("緩速", 2, LDAttributeType.ATTACK);
    }
    ...
    public void eventMethod(LDEventData data) {
        ...
        victim.addPotionEffect(new PotionEffect(PotionEffectType.SLOW, duration, amplifier), true);
    }
    ...
    public List<String> getPlaceholders() {
        return Collections.singletonList("緩速");
    }
}