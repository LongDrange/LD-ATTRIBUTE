...
public class CritResistAttribute extends LDSubAttribute {
    public CritResistAttribute() {
        super("暴击抵抗", 1, LDAttributeType.DEFENSE);
    }
    ...
    @Override public List<String> getPlaceholders() { return Collections.singletonList("暴击抵抗"); }
}